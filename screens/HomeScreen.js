    ...
    render() {
        return (
            ...
            <View style={styles.container} >
                ...
                <Header style={[{ backgroundColor: '#3a455c', height: 60, borderBottomColor: '#757575' }, styles.androidHeader]}>
                    <Left style={{ flexDirection: 'row' }}>
                        <Icon name="md-menu" onPress={() => this.props.navigation.openDrawer()} style={{ color: 'white', marginRight: 15 }} />
                        <FAIcon name="amazon" style={{ fontSize: 28, color: 'white' }} />
                    </Left>
                    <Right>
                ...
                <View style={{ position: 'absolute', left: 0, right: 0, top: 60, height: 75, backgroundColor: '#3a455c', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 5 }}>
                    <TouchableOpacity>
                ...
                <Content style={{ backgroundColor: '#d5d5d6', marginTop: 75 }}>
